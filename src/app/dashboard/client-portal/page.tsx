...
import { assets, workOrders, customerLocations, users, setWorkOrders, rootCauses, recommendedActions } from '@/lib/data';
...
const CURRENT_USER_ID = 'user-08'; // Mocked as client user for this portal
...
export default function ClientPortalPage() {
  ...
  const {
    ...
    // This logic finds the user's specific location, or the first location of their company as a fallback.
